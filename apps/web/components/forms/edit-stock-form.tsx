...
export function EditStockForm({ stock, onSuccess, onCancel }: EditStockFormProps) {
  ...
  const mutation = useMutation({
    mutationFn: (data: typeof formData) => stocksApi.update(stock.id, data),
    onSuccess: () => {
