...
import { incomesApi, CreateIncomeInput, Income } from "@/lib/api";
...
export function EditIncomeForm({ income, onSuccess, onCancel }: EditIncomeFormProps) {
  ...
  const mutation = useMutation({
    mutationFn: (data: CreateIncomeInput) => incomesApi.update(income.id, data),
    onSuccess: () => {
